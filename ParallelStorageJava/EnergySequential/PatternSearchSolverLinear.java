...
public class PatternSearchSolverLinear {

	private double[] arg_opt = null; // output

	public PatternSearchSolverLinear(double[] arg0, double[][] PMat, double[][] DMat,
		...
		try {
			...
			for (int elli = 0; elli < n; elli++) {
				...
				while ((argError > 10e-3 || Norm_Gamma > 10e-10) && (20 > IterationCounter)) {
